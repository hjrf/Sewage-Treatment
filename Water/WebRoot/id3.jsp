    ...
    <div class="content"> 
       ...
       <progress id="pro" value="0" max="100"></progress>        
        ...
        <div id="fade" class="black_overlay"></div> 
	       <label>bayes算法训练</label>
	       <label>训练表：</label>
	       <input id="hjr_name_xx" type="text" value="real_train_data" class="input-xlarge">
	       <label>评价标准表：</label>
	       <input  id ="hjr_name_xx" type="text" value="excel_input_standard" class="input-xlarge">
	       </br>
	       <label>【随机抽取】</label>
	       </br>
	       <label>训练数据条数：</label>
